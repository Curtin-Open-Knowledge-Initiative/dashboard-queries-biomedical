...
DECLARE var_SQL_script_name STRING DEFAULT 'p01_ver2b_query2_trials_20250310';
DECLARE var_output_table STRING DEFAULT 'p01_trials_20250310';

DECLARE var_data_trials STRING DEFAULT 'p01_theneuro_trials_aact_20250221';
DECLARE var_data_dois STRING DEFAULT 'p01_theneuro_dois_20230217';
...
CREATE TABLE `university-of-ottawa.p01_neuro_data.p01_trials_20250310`
 AS (
...
FROM `university-of-ottawa.p01_neuro_from_partners.p01_theneuro_trials_aact_20250221`
...
FROM
  ...
  `university-of-ottawa.p01_neuro_data.p01_alltrials_20250310`,
...
d_6a_pubs_data_intersect_anysource AS (
  ...
  FROM
    ...
    `university-of-ottawa.p01_neuro_from_partners.p01_theneuro_dois_20230217` as p6
