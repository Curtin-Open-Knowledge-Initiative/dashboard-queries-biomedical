---
title "Exploring Flowcharts using DiagrammeR - ver2.c"
...
graph_biomedical_main <- "digraph {
  ...
  DATA_ORG_dois_raw[label = 'ORG publication DOIs \\n@@3',
      fillcolor='#AC94F4']

  # ------ SHAPES & LABELS - DATA - ORG - clinical trials
  DATA_ORG_trials_raw[label = 'ORG Researcher Clinical Trials \\n@@_NEW5',
      fillcolor='#AC94F4']

  # ------ SHAPES & LABELS - DATA - ORG - orcid
  DATA_ORG_orcid_raw[label = 'ORG Researcher ORCIDs \\n@@6_NEW4',
      fillcolor='#AC94F4']   
...
rank=same {OUTPUT_Dashboard, DATA_PROCESSED_dois, DATA_PROCESSED_orcid, DATA_PROCESSED_oddpub, DATA_PROCESSED_trials}
  ...
  rank=same {Process_02, Process_03, Process_04}
  ...
  # ---------------------------------------------------------
  subgraph cluster_P0_Oddpub {
    style='filled'; fillcolor='#E9FAFA';

    Process_0_Oddpub[label = 'PROJECT - Oddpub Processing', fontsize=18,
        shape=rectangle, style='filled, dashed', fillcolor='#2CCCD3']
    
    DATA_ORG_dois_raw -> Process_0_Oddpub
  ...
  # ---------------------------------------------------------
  subgraph cluster_P0_Charite {
    style='filled'; fillcolor='#E9FAFA';

    Process_0_Charite[label = 'PROJECT - Charite Processing', 
        fontname='Helvetica-Bold', fontsize=18,
        shape=rectangle, style='filled, dashed', fillcolor='#2CCCD3']
    
    DATA_ORG_trials_raw -> Process_0_Charite
    Process_0_Charite -> DATA_PROJECT_charite_trials_output
    DATA_PROJECT_charite_trials_output -> Process_02
    } # END cluster_P0_Charite
  ...
  DATA_AcademicObservatory -> Process_01 [lhead = cluster_01]

  subgraph cluster_01 {
 
   Process_01_TITLE[label = 'SQL process #1', 
      fontsize=20, fontname='Helvetica-Bold',
      style='filled', color='transparent', fillcolor='#D7EFD9']

  Process_01[label = 'Create meta-list of clinical trial numbers 
    associated with DOIs using Crossref & Pubmed fields and 
    abstract search', 
      shape=rectangle, style='filled, dashed', fillcolor=white]
  

  # Links within process box
  #edge [color=pink, arrowsize=0.8, minlen = 1]
  #edge [style=bold, color=pink, ]
  #rankdir=TB;

  #nodesep=0.5; #hack
  Process_01_TITLE -> Process_01
  ...
  Process_02[label = 'SQL process #2
    ...
    shape=rectangle, style='filled, dashed', fillcolor='#D7EFD9', fontsize=18]
  ...
  #DATA_PROCESSED_orcid -> Process_03
  ...
  Process_04[label = 'SQL process #4
    ...
    fontsize=18, shape=rectangle, style='filled, dashed', fillcolor='#D7EFD9']
  
  Output_Table_1 -> Process_04
  #DATA_PROCESSED_dois -> Process_04
  #DATA_PROCESSED_oddpub -> Process_04
