---
title "Exploring Flowcharts using DiagrammeR - ver1.h"
...
```{r graph_biomedical_main, error=traceback, fig.show='show', warning=TRUE, messages=TRUE}
#------------------------------------------------|
# Main
#------------------------------------------------|
...
graph_biomedical_main <- "digraph {
  ...
  edge [color=black, arrowhead=normal, arrowsize=1, penwidth=2, 
  ...
  OUTPUT_Dashboard[label = 'Dashboard',
  ...
  # ---------------------------------------------------------
  Process_01[label = '
  SQL process #1 - Create <B>meta-list</br> of clinical trial numbers 
  associated with DOIs using Crossref & Pubmed fields and 
  abstract search', 
      shape=rectangle, style='filled, dashed', fillcolor=grey]
  ...
  # ---------------------------------------------------------
  Process_02[label = 'SQL process #2 - Match the contributed clinical trial data
   to the meta list of clinical trial numbers from Pubmed and Crossref
   and to the contributed DOIs', 
      shape=rectangle, style='filled, dashed', fillcolor=grey]
  ...
  # ---------------------------------------------------------
  Process_03[label = 'SQL process #3 - process the ORCID data for the dashbaord', 
      shape=rectangle, style='filled, dashed', fillcolor=grey]
  ...
  # ---------------------------------------------------------
  Process_04[label = 'SQL process #4 - process the Publication and Oddpub data for the dashboard', 
      shape=rectangle, style='filled, dashed', fillcolor=grey]
  ...
  Process_05[label = 'Charite Oddpub processing',
      shape=rectangle, style='filled, dashed', fillcolor='#23A3A9']
  ...
  Process_05 -> DATA_Contributed_Oddpub_raw
     ...
     [9]:Contributed_Oddpub_table_short
     [10]:Contributed_Oddpub_count1
     [11]:Contributed_trials_table_short
     [12]:Contributed_trials_count1
     [13]:Contributed_orcid_table_short
     [14]:Contributed_orcid_count1
     [15]:Dashboard_pubs_table_short
     [16]:Dashboard_pubs_count1  
     [17]:Dashboard_trials_table_short
     [18]:Dashboard_trials_count1
     [19]:Dashboard_orcid_table_short
     [20]:Dashboard_orcid_count1
   "
