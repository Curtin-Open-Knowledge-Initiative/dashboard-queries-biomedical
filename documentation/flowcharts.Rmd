---
title "Exploring Flowcharts using DiagrammeR - 2023_flowcharts_ver2j.Rmd"
...
print(paste("Contributed ORCID:", VAR_ORG_orcid_table, "has", ORG_orcid_count1,"distinct values for",VAR_ORG_orcid_var1))
...
graph_biomedical_main <- "digraph {
  ...
  edge [minlen=1, color=black, arrowhead=normal, arrowsize=1.5, penwidth=2.5]
  ...
  subgraph cluster_1 {
    ...
    PROCESS_1 -> Intermediate_Table_1 [label='  @@7 has  \\n   @@8 unique @@9', labeljust=l]
  ...
  subgraph cluster_2 {
    ...
    NODE_Imported_trials -> PROCESS_2 [label='  @@7 has\\n   @@8 unique @@9', labeljust=l]
  ...
  subgraph cluster_3 {
    ...
    # ------------------- LINKS
    NODE_Processed_orcid -> PROCESS_3 [label='  @@10 has\\n   @@11 unique @@12', labeljust=l]
  ...
  subgraph cluster_4 {
    ...
    NODE_Imported_oddpub -> process_4 [label='  @@13 has\\n   @@14 unique @@15', labeljust=l]

    NODE_Imported_dois_to_Process_4 -> process_4 [label='  @@16 has\\n   @@17 unique @@18', labeljust=l]
  ...
  NODE_Dashboard_trials -> NODE_Dashboard_MAIN [label='  @@19 has\\n   @@20 unique @@21', labeljust=l]
      [ltail = cluster_2, minlen=2]

  NODE_Dashboard_orcid -> NODE_Dashboard_MAIN [label='  @@22 has\\n   @@23 unique @@24', labeljust=l]
      [ltail = cluster_3, minlen=2]

  NODE_Dashboard_pubs -> NODE_Dashboard_MAIN [label='  @@25 has\\n   @@26 unique @@27', labeljust=l]
      [ltail = cluster_4, minlen=2]
  ...
  [3]:VAR_ORG_dois_file
  [4]:VAR_COKI_AcademicObservatory_table_short
  [5]:COKI_AcademicObservatory_count1
  [6]:VAR_COKI_AcademicObservatory_var1
  [7]:VAR_PROJECT_trials_table_short
  [8]:PROJECT_trials_count1
  [9]:VAR_PROJECT_trials_var1
  [10]:VAR_ORG_orcid_table_short
  [11]:ORG_orcid_count1
  [12]:VAR_ORG_orcid_var1
  [13]:VAR_PROJECT_Oddpub_table_short
  [14]:PROJECT_Oddpub_count1
  [15]:VAR_PROJECT_Oddpub_var1
  [16]:VAR_ORG_dois_table_short
  [17]:ORG_dois_count1
  [18]:VAR_ORG_dois_var1
  [19]:VAR_DASHBOARD_trials_table_short
  [20]:DASHBOARD_trials_count1
  [21]:VAR_DASHBOARD_trials_var1
  [22]:VAR_DASHBOARD_orcid_table_short
  [23]:DASHBOARD_orcid_count1
  [24]:VAR_DASHBOARD_orcid_var1
  [25]:VAR_DASHBOARD_pubs_table_short
  [26]:DASHBOARD_pubs_count1
  [27]:VAR_DASHBOARD_pubs_var1
