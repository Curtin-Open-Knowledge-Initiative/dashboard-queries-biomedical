---
title "Exploring Flowcharts using DiagrammeR - ver1.f"
...
graph_biomedical_main <- "digraph {
  ...
  DATA_Contributed_Oddpub_raw[label = 'Oddpub output - raw \\n@@4',
      shape=rectangle, fillcolor='#2CCCD3']
  ...
  # ---------------------------------------------------------
  Process_01[label = 'SQL process #1 - Create meta-list of clinical trial numbers associated with DOIs \\n using Crossref & Pubmed fields and abstract search', 
  ...
  ### HOW TO LABEL LINES DATA_AcademicObservatory -> P1_Combined_AO_and_Contributed[label = ' @@2 DOIs']
     ...
     [15]:Dashboard_trials_table_short
     [16]:Dashboard_pubs_table_short
     [17]:Dashboard_orcid_table_short
   "
