---
title "Exploring Flowcharts using DiagrammeR - ver2.b"
...
ORG_orcid_raw <- "ORG_orcid_YYYMM22.txt [neuro_pis_orcid.csv]"
...
graph_biomedical_main <- "digraph {
  ...
  DATA_ORG_dois_raw[label = 'Target publication DOIs \\n@@3',
      shape=oval, fillcolor='#AC94F4']

  # ------ SHAPES & LABELS - DATA - ORG - clinical trials
  DATA_ORG_trials_raw[label = 'Researcher Clinical Trials \\n@@_NEW5',
      shape=ellipse, fillcolor='#AC94F4']
  ...
  subgraph cluster_ORG_raw {
     label='Datasets provided by the Organisation'; fontsize=30; fontname = Helvetica;
     style='filled, dashed'; fillcolor='#E2D9FB';
  ...
  DATA_PROJECT_Oddpub_output[label = 'PROJECT: Oddpub processing output - Data and Software \\n@@4',
      shape=ellipse, fillcolor='#2CCCD3']
      
  # ------ SHAPES & LABELS - DATA - PROJECT - Charite Trials - OUTPUT
  DATA_PROJECT_charite_trials_output[label = 'PROJECT: Charite clinical trial processing - output \\n@@5',
      shape=ellipse, fillcolor='#2CCCD3']
  ...
  rank=same {DATA_PROCESSED_dois, DATA_PROCESSED_orcid, DATA_PROCESSED_oddpub, DATA_PROCESSED_trials}
  ...
  subgraph cluster_AcademicObservatory {
     label='Academic Observatory'; fontsize=30; fontname = Helvetica;
     style='filled, dashed';fillcolor='#FFF0E9';
...
#DATA_ORG_charite_trials_raw -> DATA_PROCESSED_trials
  ...
  subgraph cluster_P0_Oddpub {
    style='filled, dashed'; fillcolor='#E9FAFA';

    Process_0_Oddpub[label = 'Project - Oddpub Processing', fontsize=24,
        shape=rectangle, style='filled', fillcolor='#2CCCD3']
    DATA_ORG_dois_raw -> Process_0_Oddpub
    Process_0_Oddpub -> DATA_PROJECT_Oddpub_output
    }
  
  DATA_PROJECT_Oddpub_output -> DATA_PROCESSED_oddpub
  ...
  subgraph cluster_P0_Charite {
    ...
    Process_0_Charite[label = 'Project - Oddpub Processing', fontsize=24,
        shape=rectangle, style='filled', fillcolor='#2CCCD3']
    DATA_ORG_trials_raw -> Process_0_Charite
    Process_0_Charite -> DATA_PROJECT_charite_trials_output
    }
  
  DATA_PROJECT_charite_trials_output -> DATA_PROCESSED_trials
  ...
  DATA_PROCESSED_trials -> Process_02
  DATA_PROCESSED_dois -> Process_02
