---
title "Exploring Flowcharts using DiagrammeR - ver2.d"
...
graph_biomedical_main <- "digraph {
  ...
  # ---------------------------------------------------------
  # INPUT DATASETS: PROJECT - OUTPUT
  # ---------------------------------------------------------
  # ------ SHAPES & LABELS - DATA - PROJECT - Oddpub - OUTPUT
  DATA_PROJECT_Oddpub_output[label = 'Output from Oddpub processing - Data and Software \\n@@4',
      fillcolor='#2CCCD3']
      
  # ------ SHAPES & LABELS - DATA - PROJECT - Charite Trials - OUTPUT
  ...
  # ------ SHAPES & LABELS - DATA - PROCESSED - Oddpubs
  ...
  subgraph cluster_0_Oddpub{
    ...
    DATA_PROCESSED_dois -> Process_0_Oddpub
  ...
  subgraph cluster_1 {
    ...
    Process_1 -> Intermediate_Table_1 Intermediate_Table_1[label = 'Intermediate Table \\n 
  ...
  # JUNK
  #OUTPUT_Dashboard -> DATA_PROCESSED_orcid
  #OUTPUT_Dashboard -> DATA_PROCESSED_dois
  #OUTPUT_Dashboard -> DATA_PROCESSED_trials
  #OUTPUT_Dashboard -> DATA_PROCESSED_oddpub
