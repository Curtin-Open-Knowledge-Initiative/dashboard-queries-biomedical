---
title "Exploring Flowcharts using DiagrammeR - 2023_flowcharts_ver2f.Rmd"
...
VAR_ORG_orcid_file <- "ORG_orcid_YYYMM22.txt \\n[neuro_pis_orcid.csv]"
...
graph_biomedical_main <- "digraph {
  ...
  subgraph cluster_ORG_raw {
    ...
    # ------------------- NODES
     ...
     ORG_dois_raw_node[label = 'publication DOIs \\n ORG_dois_YYYMM22.txt',
        fillcolor='#AC94F4']

     ORG_trials_raw_node[label = 'Researcher Clinical Trials',
        fillcolor='#AC94F4']

     ORG_orcid_raw_node[label = 'Researcher ORCIDs',
        fillcolor='#AC94F4']   
  ...
  subgraph cluster_0_Charite {
    ...
    ORG_trials_raw_node -> Process_0_Charite
  ...
  ORG_dois_raw_node -> DATA_PROCESSED_dois
  ...
  subgraph cluster_2 {
    ...
    DATA_PROCESSED_trials -> Process_2
  ...
  ORG_orcid_raw_node -> DATA_PROCESSED_orcid
  ...
  DATA_PROJECT_Oddpub_output -> DATA_PROCESSED_dois
      [minlen=2, ltail = cluster_0_Oddpub, lhead = cluster_4]
  
  ORG_dois_raw_node -> process_4
      [label = 'e.g.\\n @@3',
      minlen=2, ltail = cluster_ORG_raw, lhead = cluster_0_Oddpub]
  ...
  subgraph cluster_4 {
    ...
    DATA_PROCESSED_dois[label = 'Target publication DOIs - imported XXX unique (XXX)',
      shape=rectangle, fillcolor=white]
